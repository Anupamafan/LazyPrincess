...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Movies_Telugu_Top')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Gᴋᴋ™ ᴍᴏᴠɪᴇ ᴛᴇᴀᴍ](https://t.me/Movies_Telugu_Top)</b>⚡\n\n🎦 <b>File Name: </b> ➥  <code>{file_caption}</code>\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n                ❤️<b>WE LOVE YOU</b>❤️\n🔥  ↭ <b>Join Now [Gᴋᴋ™ ᴍᴏᴠɪᴇ ᴛᴇᴀᴍ](https://t.me/Movies_Telugu_Top)</b> ↭  🔥")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Your Query: {query}</b> \n‌‌‌‌IMDb Data by: @Movies_Telugu_Top \n\n🏷 Title: <a href={url}>{title}</a>\n🎭 Genres: {genres}\n📆 Year: <a href={url}/releaseinfo>{year}</a>\n🌟 Rating: <a href={url}/ratings>{rating}</a> / 10 \n\n♥️ we are nothing without you ♥️ \n\n💛 Please Share Us 💛\n\n⚠️Click on the button 👇 below to get your query privately")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','Iam_Channel_Admin') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','Movies_Telugu_Top') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','Movies_Telugu_Top') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','Iam_Channel_Admin')  # WITHOUT @ [  add only handle - don't add full url  ] 
...
MULTI_CLIENT = False
name = str(environ.get('name', 'Gᴋᴋ™ ᴍᴏᴠɪᴇ ᴛᴇᴀᴍ'))
...
DOWNLOAD_TEXT_URL = "https://t.me/Movies_Telugu_Top"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/Movies_Telugu_Top"
